export function Alligator() {
    return {
      header: "Alligator",
      img: `https://upload.wikimedia.org/wikipedia/commons/thumb/0/03/American_Alligator.jpg/450px-American_Alligator.jpg`,
      text: `An average adult American alligator's weight and length is 360 kg (790 lb) and 4 m (13 ft),
